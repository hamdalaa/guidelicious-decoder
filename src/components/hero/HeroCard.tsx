...
export function HeroCard() {
  ...
  return (
    <section className="mx-auto w-full max-w-[1440px] px-5 pt-5 sm:px-8 sm:pt-8 xl:px-12">
      ...
      {/* Mobile — structured: title, tagline, contained image, actions */}
      <div className="overflow-hidden rounded-[16px] bg-edio-sky/25 md:hidden">
        <div className="flex flex-col gap-5 px-5 pt-6 pb-5">
          <div>
            <h1
              className="font-semibold leading-[1.08] text-edio-navy"
              style={{ fontSize: "clamp(28px, 8vw, 38px)" }}
            >
              {t("hero.headline")}
            </h1>
            <p className="mt-3 text-[14px] leading-[1.5] text-edio-navy/75">
              {t("hero.tagline")}
            </p>
          </div>
          ...
          <div className="flex w-full items-center justify-center">
            <img
              src={heroImg.url}
              alt=""
              className="block h-auto w-full max-h-[320px] object-contain"
          ...
          <div className="flex flex-col gap-2.5">
            <a
              href="#shop"
              className="edio-btn-primary inline-flex h-[46px] w-full items-center justify-center rounded-[10px] bg-edio-navy px-6 text-[14px] font-medium leading-none text-white active:opacity-95"
            >
              {t("hero.cta.explore")}
            </a>
            <a
              href="#audio"
              className="edio-btn-secondary inline-flex h-[46px] w-full items-center justify-center rounded-[10px] border-[1.5px] border-edio-navy/85 px-6 text-[14px] font-medium leading-none text-edio-navy active:opacity-95"
            >
              {t("hero.cta.shopAudio")}
            </a>
          </div>
