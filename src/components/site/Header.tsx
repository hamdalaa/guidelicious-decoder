...
export function Header() {
  ...
  return (
    <header
      ref={headerRef}
      className={cn(
        "sticky top-0 z-40 bg-edio-cream",
      ...
      {portalReady &&
        createPortal(
          ...
          >
            ...
            <aside
              className={cn(
                "absolute inset-y-0 start-0 flex h-dvh min-h-dvh w-[86%] max-w-[380px] flex-col overflow-hidden bg-white shadow-2xl transition-transform duration-200 ease-out",
